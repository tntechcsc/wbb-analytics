...
const ExportPage = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
        fetch(`http://localhost:3001/api/seasons/${selectedSeason}/gamesDate`).then(res => res.json()),
        fetch(`http://localhost:3001/api/seasons/${selectedSeason}/practicesDate`).then(res => res.json())
