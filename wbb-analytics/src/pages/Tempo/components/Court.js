...
// import isPlayerSelectedforShot from "./ShotPopup";
// import { player } from "./ShotPopup";
// import { PlayerSelectedforShot } from "../Tempo";
...
//   // useEffect(() => {
//   //   //set isPlayer to the same value as isPlayerSelectedforShot
//   //   // setIsPlayer(isPlayerSelectedforShot);
//   //   {isPlayerSelectedforShot ? setIsPlayer(true) : setIsPlayer(false)}
//   // }, []);

//   const handleOverlayClick = () => {
//     setIsShotPopupOpen(false);
//     setIsPlayer(false);
//     // isPlayerSelectedforShot(false);
//   };
...
//       setIsShotPopupOpen(false);
//      // {PlayerSelectedforShot ? alert("true") : alert("false")}
//   };
